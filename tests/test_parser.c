...
MunitTest test_parser[] = {
  ...
  {"/no_surface"            , test_no_surface            , test_setup_gl, test_teardown_gl, MUNIT_TEST_OPTION_NONE, NULL},
  {"/add_surface"           , test_add_surface           , test_setup_gl, test_teardown_gl, MUNIT_TEST_OPTION_NONE, NULL},
